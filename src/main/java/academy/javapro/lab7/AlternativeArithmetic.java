...
public class AlternativeArithmetic {
    ...
    public static void main(String[] args) {
        int[][] additionTests = {{5, 3}, {-2, 7}, {0, 0}, {-5, -3}, {100, 200}, {Integer.MAX_VALUE, 1}, {-100, 100}};
        ...
        int[][] divisionTests = {{10, 2}, {15, 3}, {8, 4}, {7, 2}, {100, 10}, {-15, 3}, {15, -3}, {0, 5}, {1024, 2}};
        ...
        int[][] subtractionTests = {{10, 3}, {5, 8}, {0, 0}, {-5, -3}, {100, 50}};
